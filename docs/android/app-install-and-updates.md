...
![Tap Install on Play Store](../img/android/37-install-from-play-store.png)
...
![App installing on Play Store](../img/android/39-play-store-installing.png)
...
![Tap Open on Play Store](../img/android/38-play-store-open.png)
